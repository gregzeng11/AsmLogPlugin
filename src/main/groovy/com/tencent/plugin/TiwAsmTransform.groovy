...
class TiwAsmTransform extends Transform {
    Project project
    MethodHookConfig mtc

    TiwAsmTransform(Project project) {
        this.project = project
        this.mtc = project.MethodHook
    }
    ...
    void handleDirectoryInput(DirectoryInput directoryInput, TransformOutputProvider outputProvider) {
        println '--------------- LifecyclePlugin handleDirectoryInput --------------- '
        //是否是目录
        if (directoryInput.file.isDirectory()) {
            ...
            directoryInput.file.eachFileRecurse { File file ->
                ...
                if (checkClassFile(name)) {
                    ...
                    ClassVisitor cv = new LifecycleClassVisitor(classWriter,mtc)
    ...
    void handleJarInputs(JarInput jarInput, TransformOutputProvider outputProvider) {
        println '--------------- LifecyclePlugin handleJarInputs --------------- '
